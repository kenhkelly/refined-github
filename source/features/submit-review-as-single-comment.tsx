...
async function handleReviewSubmission(event: delegate.DelegateEvent): Promise<void> {
...
async function handleSubmitSingle(event: delegate.DelegateEvent): Promise<void> {
